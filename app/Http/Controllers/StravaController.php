...
class StravaController extends Controller
{
	...
	public function running(Request $request)
	{
		...
		$stravaUser = $this->api->get('athlete');

		if(isset($stravaUser->id)) {
			$loggedInUser = Auth::user();
			$loggedInUser->date_preference = $stravaUser->date_preference;
			$loggedInUser->measurement_preference = $stravaUser->measurement_preference;
			$loggedInUser->save();
		}
